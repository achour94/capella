...
public class ImagePathRemoveResolver extends AbstractCapellaMarkerResolution {
  ...
  public boolean removeImagePathInRichText(EObject eObject, String featurename, String imagePath, TransactionalEditingDomain ted) {
  ...
  public void run(IMarker marker_p) {
    ...
    if (imagePathStatus != null && sessionOpt.isPresent()) {
      ...
      if (!fixSucceeded) {
        ...
        fixSucceeded = removeImagePathInRichText(target, eAttribute.getName(),
